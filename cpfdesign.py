...
# Form implementation generated from reading ui file 'cpfdesign.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnGeraCPF.setMinimumSize(QtCore.QSize(150, 0))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.labelRetorno.setMinimumSize(QtCore.QSize(0, 45))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.labelRetorno.setFont(font)
        self.labelRetorno.setStyleSheet("color: blue;")
